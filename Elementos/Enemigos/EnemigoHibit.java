...
public class EnemigoHibit extends Enemigo{
    ...
    protected void cargarAnimaciones() {
        ...
        BufferedImage img = LoadSave.GetSpriteAtlas("enemigos/HIBIT130x130.png");
        ...
        for (int j = 0; j < spritesEnemigo.length; j++) {
            switch (j) {
                case 0 -> framesEnFila = 12; // Inactivo/Idle
        ...
        animaciones.setNumFramesPorAnimacion(INACTIVO, 12); // 6 frames para inactivo/idle
