...
public class EnemigoAranara extends Enemigo{
    ...
    protected void cargarAnimaciones() {
        ...
        animaciones.setNumFramesPorAnimacion(INACTIVO, 16); // 6 frames para inactivo/idle
        ...
        animaciones.setNumFramesPorAnimacion(DISPARO, 9);   // 2 frames para disparo
