...
public class EnemigoEnergy extends Enemigo {
    ...
    private static final int ANCHO_DEFAULT = 74;
    private static final int ALTO_DEFAULT = 58;
    ...
    public EnemigoEnergy(float x, float y) {
        ...
        inicializarEnemigo(16, 10, 55, 46, true, true);
    ...
    protected void cargarAnimaciones() {
        ...
        BufferedImage img = LoadSave.GetSpriteAtlas("enemigos/ENERGY30x30.png");
        ...
        spritesEnemigo = new BufferedImage[3][4]; // 3 acciones, máximo 6 frames
        ...
        for (int j = 0; j < spritesEnemigo.length; j++) {
            switch (j) {
                ...
                case 1 -> framesEnFila = 4; // Correr/Moverse
